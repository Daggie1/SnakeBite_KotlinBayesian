...
class RecommedationByDiseaseRecyclerAdapter(val context: Context, val diseaseId:String) : RecyclerView.Adapter<RecommedationByDiseaseRecyclerAdapter.ViewHolder>()
{
    ...
    override fun getItemCount(): Int {
        ...
        return DataManager.findTreatmentsSymptomById(diseaseId = diseaseId).size

    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val symptom = DataManager.findTreatmentsSymptomById(diseaseId)[position]
        holder.textSymptomTitle.text = symptom
holder.sympomImage.setImageResource(R.drawable.ic_menu_slideshow)
